...
(function(c) {
        ...
        r.prototype.L = function(a) {
            ...
            0 > a && (n = this.a("negative"),
                k = this.a("negativeBefore"));
            a = Math.abs(a).toFixed(d).toString();
            a = a.split(".");
            this.a("thousand") ? (m = c(a[0]).match(/.{1,3}/g),
                m = c(m.join(c(this.a("thousand"))))) : m = a[0];
        ...
        r.prototype.w = function(a) {
            ...
            this.a("negative") && (d = "",
                a = a.replace(RegExp("^" + c(this.a("negative"))), "-"));
        ...
        k.prototype.p = function(a, h, d, k) {
            this.g = d;
            this.update = !k;
            if ("string" === typeof a && 0 === a.indexOf("-tooltip-"))
                this.K(a, h);
        ...
        function h(a, b) {
            ...
            if (a.m)
                return g = a.c[c - 1],
                    ...
                    b - g > (c - g) / 2 ? c : g;
            a.h[c - 1] ? (g = a.h[c - 1],
                c = a.c[c - 1] + Math.round((b - a.c[c - 1]) / g) * g) : c = b;
            return c
        }
        function d(a, b) {
            if (!m(b))
        ...
        function V(d, b, m) {
            ...
            function w(a, c, d, e) {
                ...
                c.on(a, function(a) {
                    ...
                    c && (g = a.changedTouches[0].pageX,
                        k = a.changedTouches[0].pageY);
                    if (p || F)
                        F || void 0 !== window.pageXOffset || (window.pageXOffset = document.documentElement.scrollLeft,
            ...
            function C(a, c) {
                ...
                d = e + k[0];
                e += k[1];
                1 < b.length ? (0 > d && (e += Math.abs(d)),
                100 < e && (d -= e - 100),
                    d = [Math.max(Math.min(d, 100), 0), Math.max(Math.min(e, 100), 0)]) : d = [d, e];
            ...
            function v(a, b) {
                ...
                w(z.end, G, s, null);
                a.cursor && (c("body").css("cursor", c(a.target).css("cursor")),
            ...
            d.vSet = function() {
                ...
                for (m = 0; m < a; m++)
                    ...
                    !1 !== h && (h = A(b, h),
                    b.dir && (h = 100 - h),
                    !0 !== u(l[m % 2], h, !0) && c(y[m % 2]).each(function(a) {
                        if (!a)
                            return s = this.u,
                                !0;
