...
async function WAAPlayer(audioBuffer, frameSize, bufferSize, speed, pitchShift) {
    ...
    return new Promise((resolve) => {
        ...
        if (pitchShift === 1) {
            return processSpeed(audioBuffer, speed, resolve, _pv, bufferSize);
        } else if (speed === 1) {
            return processPitch(audioBuffer, speed, resolve, _pv, bufferSize, pitchShift);
        } else {
            return processAll(audioBuffer, speed, resolve, _pv, bufferSize, pitchShift);
        }
    })

}

function processSpeed(audioBuffer, speed, resolve, _pv, bufferSize) {
...
function processPitch(audioBuffer, speed, resolve, _pv, bufferSize, pitchShift) {
    let durationWithSpeedFactor = audioBuffer.duration * speed;
    durationWithSpeedFactor += 1;
...
function processAll(audioBuffer, speed, resolve, _pv, bufferSize, pitchShift) {
    let durationWithSpeedFactor = audioBuffer.duration * speed;
    durationWithSpeedFactor += 1;
